...
export default function CardPost(props) {
  ...
  return (
    <div className="d-flex flex-column align-items-start" style={{padding:'5px',height:'80px',borderTopStyle:'solid'}}>
      <button className="btn" onClick={handleClickTitle} style={{fontWeight:'bold',maxWidth:'100%',textOverflow:'ellipsis',whiteSpace:'nowrap',overflow:'hidden'}}>{props.post.question}</button>
